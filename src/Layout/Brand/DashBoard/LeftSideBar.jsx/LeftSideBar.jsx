        ...
        <div className=' w-[50px]   flex flex-col items-center  justify-between  h-screen'>  {/* Setting the Width - Height of Container  */}
          ...
          <div className='flex flex-col items-center gap-5'>
            ...
            <div className='  '>   {/* Contains the Buttons of Left Side Bar */}
              ...
              <div onClick={() => { setactiveButton(5); setActivePage(0) }} onMouseEnter={() => { setisHover(0) }}
                onMouseLeave={() => { setisHover(-1) }} className={`size-[30px] rounded-xl   grid place-items-center bg-gray-200/90         hover:outline-none hover:ring-2 hover:ring-ring hover:ring-offset-2  ${activeButton === 5 ? 'Button' : ''} relative`}>  {/* Search Icon  */}
