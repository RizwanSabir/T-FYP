...
const Dashbaord = () => {
  ...
  <>
    ...
    <ScreenSizeDisplay/>
  <div className=" mx-10 mt-2 grid gap-y-4  xs:grid-cols-3 xs:grid-rows-3   md:grid-cols-6 md:grid-rows-1   justify-center items-center">
...
<div className="flex justify-center   gap-x-5  mt-5">
  ...
  <div className="bg-white rounded-3xl px-4 py-5">
...
<InfluencerList ImageSrc="/Media/p7.jpg" Name="Ali khan" Time="2 hours" Bio="Just posting #fun #Enjoyable" ColorBorder="SilverButtonWithText" Status="Instruction Sent" TextColor="text-gray-500"/>
...
const InfluencerList = ({ImageSrc,Name,Time,Bio,ColorBorder,Status,TextColor}) => {
 ...
 <div className="text-[12px] poppins-regular ml-2 mr-2">
    <p className="text-[14px] poppins-semibold">{Name}</p>
    <p className=" poppins-regular text-black/40">{Time}</p>
    <p>{Bio}</p>
  </div>

  <div className="text-[12px] w-[120px] text-center">
  <p className={`${ColorBorder} text-[9px] sm:text-[12px]  xs:text-[10px]  cursor-pointer  ${TextColor}`}  >{Status}</p>
  </div>
 </div>
    ...
    <div className="bg-white   rounded-3xl mb-10">
      <div className="px-5 py-5 flex flex-col">
        <p className="lato-bold text-lg">Media</p>
          ...
          <div className="mt-2 grid xs:grid-cols-1  md:grid-cols-2 gap-4  ">
...
const ProfileMedia = ({ PostImageSrc,ProfileImage,name,Likes,Comments,Reach,Engagement }) => {
  ...
  return (
      <>
          ...
          <div className=" text-[10px] lg:text-[12px] w-[250px] h-[370px] mdm:w-[150px] mdm:h-[250px] bg-white rounded-2xl flex flex-col  OverViewBox1 justify-self-center">
              <div className="w-[150px]   rounded-xl overflow-hidden ">
                  ...
                  <div className="ml-3 text-[10px] mt-2 px-2">
                      <p >This is a wondorful day #enjoy #weather#beautifuk</p>
